...
genera.hmap <- ggplot(genera.hmap.dat, aes(SampleID, MinRank, fill=log10(count))) +
  geom_tile(color="grey80", size=0.4) +
  viridis::scale_fill_viridis(na.value="white", option = "A", labels=function(x) 10^(as.numeric(x))) +
  theme_classic() +
  theme(
...
species.hmap <- ggplot(species.hmap.dat, aes(SampleID, MinRank, fill=log10(count))) +
  geom_tile(color="grey80", size=0.4) +
  viridis::scale_fill_viridis(na.value="white", option = "A", labels=function(x) 10^(as.numeric(x))) +
  theme_classic() +
  theme(
